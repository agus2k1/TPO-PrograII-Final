package ejercicios_sueltos.ejercicio1.interfaces;
...
public interface ConjuntoEspecialTDA {
	...
	public Respuesta agregar(int valor); 
		...
		//Agrega un valor al conjunto. La
